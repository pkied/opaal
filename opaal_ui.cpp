...
void OpaalUI::run() {
  ...
  if (this->_selectButton.wasReleased()) {
    ...
    if (this->_mode == 3) { word h=this->_conf->getCnfStartHour()+1; if (h > 10) h = 4; this->_conf->setCnfStartHour(h); this->_scheduler->simpleSetup(this->_conf->getCnfStartHour(), this->_conf->getCnfStartMinute(), this->_conf->getCnfDayDurationHours(), this->_conf->getCnfMoonDurationHours(), 3600000); }
    if (this->_mode == 4) { word m=this->_conf->getCnfStartMinute()+1; if (m > 59) m = 0; this->_conf->setCnfStartMinute(m); this->_scheduler->simpleSetup(this->_conf->getCnfStartHour(), this->_conf->getCnfStartMinute(), this->_conf->getCnfDayDurationHours(), this->_conf->getCnfMoonDurationHours(), 3600000); }
    if (this->_mode == 5) { word h=this->_conf->getCnfDayDurationHours()+1; if (h > 12) h = 4; this->_conf->setCnfDayDurationHours(h); this->_scheduler->simpleSetup(this->_conf->getCnfStartHour(), this->_conf->getCnfStartMinute(), this->_conf->getCnfDayDurationHours(), this->_conf->getCnfMoonDurationHours(), 3600000); }
    if (this->_mode == 6) { word h=this->_conf->getCnfMoonDurationHours()+1; if (h > 4) h = 1; this->_conf->setCnfMoonDurationHours(h); this->_scheduler->simpleSetup(this->_conf->getCnfStartHour(), this->_conf->getCnfStartMinute(), this->_conf->getCnfDayDurationHours(), this->_conf->getCnfMoonDurationHours(), 3600000); }
    ...
    if (this->_mode == 9) { this->_mvSave(); this->_mode = 0;}
  }
  ...
  if (this->_mode == 5) { sprintf(vbuf,"%02u", this->_conf->getCnfDayDurationHours()); this->_mvSettings("Day duration: hours", vbuf); }
  if (this->_mode == 6) { sprintf(vbuf,"%02u", this->_conf->getCnfMoonDurationHours()); this->_mvSettings("Moon duration: hours", vbuf); }
  ...
  if (this->_mode == 9) { this->_mvSettings("Save settings?", "No"); }
}
